...
public class Constants {
    ...
    public enum File {
        ...
        USER_AVATAR_FOLDER("D:\\code/avatar"),

        GROUP_AVATAR_FOLDER("D:\\code/group"),

        HOME_CAROUSEL_FOLDER("D:\\code/carousel"),

        MARKDOWN_FILE_FOLDER("D:\\code/md"),

        PROBLEM_FILE_FOLDER("D:\\code/problem"),

        CONTEST_TEXT_PRINT_FOLDER("D:\\code/contest_print"),

        IMG_API("D:\\code/img/"),

        FILE_API("D:\\code/file/"),

        TESTCASE_TMP_FOLDER("D:\\code/zip"),

        TESTCASE_BASE_FOLDER("D:\\code/testcase"),

        FILE_DOWNLOAD_TMP_FOLDER("D:\\code/download"),

        CONTEST_AC_SUBMISSION_TMP_FOLDER("D:\\code/contest_ac");
